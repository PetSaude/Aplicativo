 ...
 */
public class AdapterVaga extends BaseAdapter {
    ...
    public AdapterVaga(Context context, ArrayList<Vaga> itens)
        {
            this.itens = itens;
        ...
        public View getView(int position, View view, ViewGroup parent)
        {
            ...
            for (Animal animal : Session.getUsuarioLogado().getListaAnimais()){
                if (animal.getId() == item.getIdAnimal()){
                    nomeAnimal = animal.getNome();
                    break;
                }
            }
            for (Clinica clinica : Session.getListaClinicas()){
                if (clinica.getId() == item.getIdClinica()){
